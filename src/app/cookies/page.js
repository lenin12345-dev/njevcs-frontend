...
const CookiePolicy = () => {
  return (
    <Container maxWidth="md" sx={{ py: 4 }}>
      ...
      <ul>
        <li>
          <Typography>Session Management: To maintain your session while you navigate our platform, ensuring smooth transitions between pages and functions.</Typography>
        </li>
        <li>
          <Typography>Search History Tracking: Temporary cookies help us store recent search queries and preferences.</Typography>
        </li>
        <li>
          <Typography>Performance and Analytics: Cookies allow us to analyze how users interact with our site.</Typography>
        </li>
        <li>
          <Typography>Personalization: Cookies help us remember your preferences, such as language and location settings.</Typography>
        </li>
      </ul>
      ...
      <ul>
        <li>
          <Typography>Browser Settings: Most browsers allow you to view, manage, delete, and block cookies for specific sites.</Typography>
        </li>
        <li>
          <Typography>Opt-Out of Analytics Cookies: To opt out of third-party analytics cookies, you may adjust your settings on the relevant provider’s website.</Typography>
        </li>
      </ul>
